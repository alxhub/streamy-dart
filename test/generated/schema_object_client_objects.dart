...
class Context_Facets extends streamy.EntityWrapper {
  ...
  factory Context_Facets.fromJsonString(String strJson, streamy.Trace trace,
      ...
      var parsed = streamy.jsonParse(strJson);
      trace.record(new streamy.JsonParsedTraceEvent());
      var res = new Context_Facets.fromJson(parsed, typeRegistry: typeRegistry);
      trace.record(new streamy.EndDeserializeTraceEvent());
      return res;
  }
...
class Context extends streamy.EntityWrapper {
  ...
  factory Context.fromJsonString(String strJson, streamy.Trace trace,
      ...
      var parsed = streamy.jsonParse(strJson);
      trace.record(new streamy.JsonParsedTraceEvent());
      var res = new Context.fromJson(parsed, typeRegistry: typeRegistry);
      trace.record(new streamy.EndDeserializeTraceEvent());
      return res;
  }
...
class $some_entity_ extends streamy.EntityWrapper {
  ...
  factory $some_entity_.fromJsonString(String strJson, streamy.Trace trace,
      ...
      var parsed = streamy.jsonParse(strJson);
      trace.record(new streamy.JsonParsedTraceEvent());
      var res = new $some_entity_.fromJson(parsed, typeRegistry: typeRegistry);
      trace.record(new streamy.EndDeserializeTraceEvent());
      return res;
  }
